...
function MessagePage() {
    ...
    }, [cookie, message, selectedConversation]);
    ...
    const formatDate = (timestamp?: Date | string): string => {
        ...
        return date.toLocaleString('en-US', { hour: 'numeric', minute: 'numeric', hour12: true, day: 'numeric', month: 'short', year: 'numeric' });
    };
    ...
    const startConversation = async (userId: string) => {
        try {
            const response = await axios.post('http://localhost:8000/chat/conversation', {
    ...
    const debouncedSendMessage = useCallback(
        _.debounce(handleSendMessage, 300),
                    ...
                    <Footer style={{ padding: '16px', background: '#fff', borderTop: '1px solid #f0f0f0' }}>
                        <div style={{ display: 'flex', alignItems: 'center' }}>
                            ...
                            <TextArea
                                ...
                                onPressEnter={debouncedSendMessage}
                            />
                            <Button
                                type="primary"
                                icon={<SendOutlined />}
